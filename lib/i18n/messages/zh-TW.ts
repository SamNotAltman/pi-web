...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.passkeysDescription": "使用裝置的指紋、臉部或安全金鑰登入，不必再輸入密碼。",
    "settings.passkeysEmpty": "尚未註冊 Passkey。",
    "settings.passkeysAdd": "新增 Passkey",
    "settings.passkeysAdding": "正在新增...",
    "settings.passkeysRemove": "刪除",
    "settings.passkeysUnsupported": "目前的瀏覽器不支援 Passkey。",
    "settings.passkeysLoadFailed": "無法載入 Passkey 清單。",
    "settings.passkeysAddFailed": "新增 Passkey 失敗，請再試一次。",
    "settings.passkeysRemoveFailed": "刪除 Passkey 失敗，請再試一次。",
    "settings.projectRequired": "開啟專案後才能設定此項",
    "auth.prompt": "登入後繼續使用",
    "auth.signInWithPasskey": "使用 Passkey 登入",
    "auth.verifyingPasskey": "正在驗證...",
    "auth.usePassword": "改用密碼登入",
    "auth.usePasskey": "改用 Passkey 登入",
    "auth.passkeyFailed": "Passkey 登入失敗，請再試一次。",
    "auth.setupPasskeyHint": "尚未註冊 Passkey。請先用密碼登入，再於「設定 → Passkeys」新增。",
    "auth.password": "密碼",
    "auth.logIn": "登入",
    "auth.rememberMe": "記住我",
    "auth.loggingIn": "正在登入...",
