...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.passkeysDescription": "Sign in with your device's fingerprint, face, or security key instead of the password.",
    "settings.passkeysEmpty": "No passkey registered yet.",
    "settings.passkeysAdd": "Add passkey",
    "settings.passkeysAdding": "Adding...",
    "settings.passkeysRemove": "Remove",
    "settings.passkeysUnsupported": "This browser does not support passkeys.",
    "settings.passkeysLoadFailed": "Could not load passkeys.",
    "settings.passkeysAddFailed": "Could not add the passkey. Try again.",
    "settings.passkeysRemoveFailed": "Could not remove the passkey. Try again.",
    ...
    "auth.verifyingPasskey": "Verifying...",
    "auth.usePassword": "Use password instead",
    "auth.usePasskey": "Use a passkey instead",
    "auth.passkeyFailed": "Passkey sign-in failed. Try again.",
    "auth.setupPasskeyHint": "No passkey registered yet. Sign in with the password, then add one under Settings → Passkeys.",
    ...
    "chat.newSession": "New",
    "chat.newSessionTitle": "New session in {path}",
