...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.passkeysDescription": "使用设备的指纹、面容或安全密钥登录，不再输入密码。",
    "settings.passkeysEmpty": "尚未注册 Passkey。",
    "settings.passkeysAdd": "添加 Passkey",
    "settings.passkeysAdding": "正在添加...",
    "settings.passkeysRemove": "删除",
    "settings.passkeysUnsupported": "当前浏览器不支持 Passkey。",
    "settings.passkeysLoadFailed": "无法加载 Passkey 列表。",
    "settings.passkeysAddFailed": "添加 Passkey 失败，请重试。",
    "settings.passkeysRemoveFailed": "删除 Passkey 失败，请重试。",
    "settings.projectRequired": "打开项目后才能配置此项",
    "auth.prompt": "登录后继续使用",
    "auth.signInWithPasskey": "使用 Passkey 登录",
    "auth.verifyingPasskey": "正在验证...",
    "auth.usePassword": "改用密码登录",
    "auth.usePasskey": "改用 Passkey 登录",
    "auth.passkeyFailed": "Passkey 登录失败，请重试。",
    "auth.setupPasskeyHint": "还没有注册 Passkey。先用密码登录，然后在“设置 → Passkeys”中添加。",
    "auth.password": "密码",
    "auth.logIn": "登录",
    "auth.rememberMe": "记住我",
    "auth.loggingIn": "正在登录...",
    ...
    "chat.newSession": "新建",
    "chat.newSessionTitle": "在 {path} 中新建会话",
